    ...
    <main className="m-auto flex max-w-7xl flex-col gap-4">
      <div>
        ...
        <p className="text-center text-lg">
          On site: November 24th - December 2nd 2024
        </p>
      </div>
      <img
      ...
      />
      <p>
        <b>We are very pleased to announce the twelfth joint Diamond-CCP4 MX workshop for graduate students, postdocs and early career scientists.</b>
      </p>
    <p>
      All aspects of structure solution will be covered during the
      workshop, from data collection through to phasing, refinement,
      validation and deposition. Please see the
