...
export function Accommodation() {
  ...
  return (
    ...
    <p>Rooms for both students and speakers have been arranged at{" "}
        <Link
          href="http://www.thebearwantage.co.uk/"
          text="The Bear hotel"
        />{" "}
      in Wantage.
    </p>
    ...
    <p><Link
          href="https://en.wikipedia.org/wiki/Wantage"
          text="Wantage"
        />{" "} is a small market town,
      about 8 miles west of Diamond, which claims to be the birthplace of King Alfred.
      ...
      good insight into the history of the local area.
    </p>
    <Heading text="Transport" />

    <p>The Oxford Bus Company{" "}
    <Link
          href="https://www.oxfordbus.co.uk/services/THTR/X35"
          text="X35"
        />
    {" "}
    route
    serves the Harwell campus and picks up in Wantage immediately
    ...
    <p>Parking at The Bear is not free, but cheap parking is available nearby.
    </p>
